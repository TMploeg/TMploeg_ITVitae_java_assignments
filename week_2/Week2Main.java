public class Week2Main {
  public static void main(String[] args) {
    ...
    int selectedOption =
        ConsoleHelper.getPositiveNumberInputInRange("what do you want to do?", 1, options.length);
      ...
      case 2:
        ...
        System.out.println(
            "temperature in Fahrenheit: "
                + TemperatureConverter.convertCelciusToFahrenheit(celcius));
        break;
      case 3:
        double fahrenheit = ConsoleHelper.getDoubleInput("temperature in Fahrenheit");
        System.out.println(
            "temperature in Celcius: "
                + TemperatureConverter.convertFahrenheitToCelcius(fahrenheit));
        break;
      case 4:
  ...
  private static void runCalculateVelocity() {
    ...
    VelocityCalculator.VelocityData vData =
        VelocityCalculator.calculate(
            meters, new VelocityCalculator.TimeData(hours, minutes, seconds));
